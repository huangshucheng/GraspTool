...
function TaskTMP:ctor()
	self.CUR_TASK_TITLE = "华夏基金"  --当前任务标题
	self.FIND_STRING_HOST = "wx.hoyatod.cn"  --域名，方便查找token
	self.FILE_SAVE_NAME = "task_hxjj_token.lua" -- 保存本地token文件名字
	self.RECORD_SAVE_FILE_NAME = "task_hxjj_record.lua" --交互记录文件
